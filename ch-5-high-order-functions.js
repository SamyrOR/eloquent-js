...
console.log(every([1, 3, 4, 5, 16], (n) => n > 10));

console.log(every2([14, 22, 42, 51, 16], (n) => n > 10));
...
function dominantDirection(text) {
  ...
  return scripts.reduce((a, b) => (b.count > a.count ? b : a)).name.direction;
}
